...
public class MemberRepositoryTest {
    ...
    void saveMember() {
        ...
        assertNotNull(
            savedMember);                                             // savedMember가 null이면 안 됨.
        assertTrue(member3.getMemberId()
            .equals(savedMember.getMemberId()));    // savedMember와 member3의 필드가 동일한지 검증.
    ...
    void updateMember() {
        ...
        assertNotNull(
            updatedMember);                                           // updateMember가 null이면 안 됨.
        assertTrue(member1.getMemberId()
            .equals(updatedMember.getMemberId()));  // updateMember와 mebmer1의 필드가 동일한지 검증.
    ...
    void findMemberById() {
        ...
        assertTrue(member2.getMemberId()
            .equals(obtainedMember.getMemberId())); // obtainedMember와 member2의 필드가 동일한지 검증.
